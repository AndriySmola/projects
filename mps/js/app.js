(() => {
    ...
    function windowLoad() {
        ...
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.closest(".navigation-popular__item")) {
                const tabNavItem = targetElement.closest(".navigation-popular__item");
                if (!tabNavItem.classList.contains("active")) {
                    const activeTabNavItem = document.querySelector(".navigation-popular__item.active");
