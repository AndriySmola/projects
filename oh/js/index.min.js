import"./main.min.js";import{b as H,a as B,g as P}from"./common.min.js";function $(){document.addEventListener("click",function(r){H&&r.target.closest("[data-fls-menu]")&&(B(),document.documentElement.toggleAttribute("data-fls-menu-open"))})}document.querySelector("[data-fls-menu]")&&window.addEventListener("load",$);/*!
