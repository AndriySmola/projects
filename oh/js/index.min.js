import"./main.min.js";import{b as H,a as P}from"./common.min.js";function F(){document.addEventListener("click",function(r){H&&r.target.closest("[data-fls-menu]")&&(P(),document.documentElement.toggleAttribute("data-fls-menu-open"))})}document.querySelector("[data-fls-menu]")&&window.addEventListener("load",F);/*!
