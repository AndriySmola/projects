(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu")) {
                ...
                if (document.documentElement.classList.contains("_submenu-open")) document.documentElement.classList.remove("_submenu-open");
            }
        }));
    }
    ...
    function initSliders() {
        ...
        if (document.querySelector(".thumbs-images")) {
            ...
            new swiper_core_Swiper(".images-main-product__slider", {
                modules: [ Autoplay, Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        if (targetElement.closest("[data-parent]")) {
            ...
            if (subMenu) {
                ...
                if (activeLink && activeLink !== targetElement) {
                    ...
                    document.documentElement.classList.remove("_submenu-open");
                }
                document.documentElement.classList.toggle("_submenu-open");
                targetElement.classList.toggle("_submenu-active");
                subMenu.classList.toggle("_submenu-open");
            } else console.log("Нема такого підменю :(");
            e.preventDefault();
        }
